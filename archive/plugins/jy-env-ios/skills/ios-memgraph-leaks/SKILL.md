...
description: Use when capturing or inspecting iOS leaks and memgraphs to debug leaked objects, retain cycles, memory growth, or before-and-after leak evidence.
---
