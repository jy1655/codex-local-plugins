...
description: Use when mirroring an iOS Simulator into the Codex in-app browser, rendering SwiftUI previews with hot reload, iterating outside Xcode Canvas, or capturing browser-visible simulator proof.
---
