...
description: Use when capturing or interpreting iOS Simulator ETTrace profiles for launch latency, runtime latency, trace comparison, or CPU-heavy stack analysis.
---
