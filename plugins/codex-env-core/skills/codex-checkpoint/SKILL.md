...
files_modified:
  - plugins/codex-env-core/skills/codex-checkpoint/SKILL.md
```
...
- 이렇게 유도한다:
  - "현재는 Plan Mode라 checkpoint 파일을 실제로 쓰지 않습니다. `Shift+Tab`으로 Default mode로 나온 뒤 `/codex-checkpoint save`를 다시 실행하세요."
