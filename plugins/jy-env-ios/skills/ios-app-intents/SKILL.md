...
description: Use when designing App Intents, app entities, or App Shortcuts that expose app actions and content to Shortcuts, Siri, Spotlight, widgets, or controls.
---
